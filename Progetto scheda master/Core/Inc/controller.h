...
typedef struct controller_s {
    uint16_t ax;      // Valore analogico assegnato al comando X sinistro.
    uint16_t ay;      // Valore analogico assegnato al comando Y sinistro.
    uint8_t a_btn;    // Stato del pulsante 'a' premuto (0 o 1).

    uint16_t bx;      // Valore analogico assegnato al comando X destro.
    uint16_t by;      // Valore analogico assegnato al comando Y destro.
    uint8_t b_btn;    // Stato del pulsante 'b' premuto (0 o 1).

    uint8_t btn1;     // Stato del pulsante btn1 premuto (0 o 1).
    uint8_t btn2;     // Stato del pulsante btn2 premuto (0 o 1).
} controller_t;
#pragma pack()
