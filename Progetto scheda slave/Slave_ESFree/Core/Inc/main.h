...
#define LED2_W_Pin GPIO_PIN_9
#define LED2_W_GPIO_Port GPIOC
#define LED1_R_Pin GPIO_PIN_10
#define LED1_R_GPIO_Port GPIOC
#define LED1_W_Pin GPIO_PIN_11
#define LED1_W_GPIO_Port GPIOC
#define B2_pin_Pin GPIO_PIN_4
#define B2_pin_GPIO_Port GPIOB
#define B1_pin_Pin GPIO_PIN_5
